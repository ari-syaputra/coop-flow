...
`;
   ...
   */ const getDirectChildByClass = (elem, className)=>/** @type {HTMLElement | undefined} */ Array.from(elem.children).find((child)=>child instanceof HTMLElement && hasClass(child, className));
    /**
   * @param {HTMLElement} elem
...
`.replace(/(^|\n)\s*/g, '');
   ...
   */ function handleButtonsStyling(confirmButton, denyButton, cancelButton, params) {
        ...
        /** @type {[HTMLElement, string, string | undefined][]} */ const buttons = [
            [
                confirmButton,
                'confirm',
...
`;
   ...
   */ const formatInputOptions = (inputOptions)=>{
        ...
        return entries.map(([key, value])=>[
                key,
                typeof value === 'object' ? formatInputOptions(value) : value
            ]); // case of <optgroup>
    };
    /**
   * @param {string} optionValue
...
//# sourceMappingURL=node_modules_sweetalert2_dist_sweetalert2_all_11d4ym4.js.map