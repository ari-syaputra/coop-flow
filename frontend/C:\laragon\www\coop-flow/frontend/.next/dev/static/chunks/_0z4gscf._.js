...
const getHistoricalWeatherML = async (lat, lon, yearsBack = 3)=>{
    ...
    try {
        ...
        const totalTemp = dailyData.temperature_2m_mean.reduce((acc, val)=>acc + (val || 0), 0);
        const avgTemp = totalTemp / totalDays;
        // 2. Hitung Rata-rata Kelembapan Harian selama rentang tahun
        const totalHumidity = dailyData.relative_humidity_2m_mean.reduce((acc, val)=>acc + (val || 0), 0);
        ...
        const totalPrecipitation = dailyData.precipitation_sum.reduce((acc, val)=>acc + (val || 0), 0);
...
//# sourceMappingURL=_0z4gscf._.js.map